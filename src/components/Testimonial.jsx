    ...
    return (
        <section className="py-32 bg-primary text-on-primary">
            <div className="container mx-auto px-8 max-w-5xl text-center">
                ...
                >
                    <span className="material-symbols-outlined text-6xl text-[#0F4C81]-container/40 mb-12">format_quote</span>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="font-body text-xs text-[#0F4C81]-container/80 mt-1">CEO, Meridian Global Holdings</p>
                    </div>
                </motion.div>
            </div>
        </section>
